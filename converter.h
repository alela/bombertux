#ifndef STRING_TO_KEY_
#define STRING_TO_KEY_
...
public:
  ...
  static std::map<std::string, sf::Keyboard::Key> init(){
...
std::map<std::string, sf::Keyboard::Key> Converter::string_to_key = Converter::init();
